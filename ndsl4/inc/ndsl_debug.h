...
#define TRACE(file, line)								printf(LIGHT_GRAY"[%s][%d]\n"CLEAR, file, line)
#define ERROR(fmt, args...)								printf(RED"[ERROR] "fmt""CLEAR, ##args)
#define WARN(fmt, args...)								printf(YELLOW"[WARNING] "fmt""CLEAR, ##args)
#define INFO(fmt, args...)								printf(YELLOW"[INFO] "fmt""CLEAR, ##args)
#define DEBUG(fmt, args...)								printf(BLUE"[DEBUG] "fmt""CLEAR, ##args)
